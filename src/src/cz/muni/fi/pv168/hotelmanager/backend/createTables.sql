...
CREATE TABLE ROOM (
    ...
    PRICE DECIMAL(9,2) CONSTRAINT PRICE_NOT_NULL NOT NULL CONSTRAINT PRICE_NOT_ZERO_NOR_NEGATIVE CHECK (PRICE > 0),
...
CREATE TABLE RESERVATION (
    ...
    SERV_SPENDINGS DECIMAL(15,2) CONSTRAINT SERVSPENDIGS_NOT_NULL NOT NULL CONSTRAINT SERVSPENDIGS_NOT_NEGATIVE CHECK (SERV_SPENDINGS >= 0),
