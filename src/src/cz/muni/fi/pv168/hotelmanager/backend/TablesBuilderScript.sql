...
CREATE TABLE GUEST (
    ...
    BORN DATE CONSTRAINT BORN_NOT_NULL NOT NULL
);
...
CREATE TABLE RESERVATION (
    ...
    START_TIME DATE CONSTRAINT STARTTIME_NOT_NULL NOT NULL,
    REAL_END_TIME DATE,
    EXPECTED_END_TIME DATE CONSTRAINT EXPECTEDENDTIME_NOT_NULL NOT NULL,    
